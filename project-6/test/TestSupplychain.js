...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        // Check if account[2] is Distributor
        ...
        let balanceOfDistributorBeforeTransaction = await web3.eth.getBalance(originFarmerID);
        ...
        // Verify the result set
        let balanceOfDistributorAfterTransaction = await web3.eth.getBalance(originFarmerID);
        let value1 = Number(balanceOfDistributorBeforeTransaction) + Number(productPrice);
        let value2 = Number(balanceOfDistributorAfterTransaction);
        assert.equal(resultBufferOne[2], distributorID, 'Error: The owner is not changed')
        assert.equal(resultBufferTwo[6], distributorID, 'Error: Invalid distributorID')
        assert.equal(resultBufferTwo[5], 4, 'Error: Invalid item State')
        assert.equal(value1, value2, "Error: The Farmer didn't received it's money");
        assert.equal(eventEmitted, true, 'Invalid event emitted')
    })    
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        // Verify the result set
        assert.equal(resultBufferOne[2], retailerID, 'Error: The owner is not changed')
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        // Verify the result set
        assert.equal(resultBufferOne[2], consumerID, 'Error: The owner is not changed')
